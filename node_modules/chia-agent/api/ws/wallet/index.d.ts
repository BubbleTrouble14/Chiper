...
export declare type WsGetConnectionsWalletMessage = GetMessageType<chia_wallet_service, get_connections_command, TGetConnectionsBroadCast>;
...
export declare type WsSyncChangedWalletMessage = GetMessageType<chia_wallet_service, sync_changed_command_of_wallet, TSyncChangedBroadCastOfWallet>;
export declare function on_sync_changed_of_wallet(daemon: TDaemon, callback: (e: WsSyncChangedWalletMessage) => unknown): Promise<() => void>;
...
export declare type WsCoindAddedMessage = GetMessageType<chia_wallet_service, coin_added_command_of_wallet, TCoinAddedBroadCastOfWallet>;
export declare function on_coin_added_of_wallet(daemon: TDaemon, callback: (e: WsCoindAddedMessage) => unknown): Promise<() => void>;
export declare type WsWalletMessage = WsGetConnectionsWalletMessage | WsSyncChangedWalletMessage | WsStateChangedWalletMessage | WsCoindAddedMessage;
